...
class ENUM_SYMBOL_CHART_MODE(Enum):
    SYMBOL_CHART_MODE_BID  = 0
    SYMBOL_CHART_MODE_LAST = auto()

class ENUM_SYMBOL_TRADE_MODE(Enum):
...
class ENUM_SYMBOL_TRADE_EXECUTION(Enum):
