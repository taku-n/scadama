# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.1 on Fri May 21 14:52:54 2021
#
...
class FrameMain(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        sizer_average = wx.BoxSizer(wx.HORIZONTAL)
        sizer_main.Add(sizer_average, 0, wx.EXPAND | wx.TOP, 10)

        self.statictext_average_sell = wx.StaticText(self.panel_main, wx.ID_ANY, "0", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        sizer_average.Add(self.statictext_average_sell, 1, 0, 0)

        statictext_average = wx.StaticText(self.panel_main, wx.ID_ANY, "Average", style=wx.ALIGN_CENTER_HORIZONTAL)
        sizer_average.Add(statictext_average, 1, 0, 0)

        self.statictext_average_buy = wx.StaticText(self.panel_main, wx.ID_ANY, "0", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        sizer_average.Add(self.statictext_average_buy, 1, 0, 0)
        ...
        sizer_swap_day = wx.BoxSizer(wx.HORIZONTAL)
        sizer_main.Add(sizer_swap_day, 0, wx.EXPAND | wx.TOP, 5)

        statictext_swap = wx.StaticText(self.panel_main, wx.ID_ANY, "Swap :")
        sizer_swap_day.Add(statictext_swap, 1, 0, 0)

        statictext_swap_x3 = wx.StaticText(self.panel_main, wx.ID_ANY, "x3 :", style=wx.ALIGN_RIGHT)
        sizer_swap_day.Add(statictext_swap_x3, 1, 0, 0)

        self.statictext_swap_x3_value = wx.StaticText(self.panel_main, wx.ID_ANY, "Day", style=wx.ALIGN_CENTER_HORIZONTAL | wx.ST_NO_AUTORESIZE)
        sizer_swap_day.Add(self.statictext_swap_x3_value, 1, 0, 0)

        sizer_swap_long = wx.BoxSizer(wx.HORIZONTAL)
        sizer_main.Add(sizer_swap_long, 0, wx.EXPAND, 0)

        statictext_swap_long = wx.StaticText(self.panel_main, wx.ID_ANY, "Long:", style=wx.ALIGN_CENTER_HORIZONTAL)
        sizer_swap_long.Add(statictext_swap_long, 1, 0, 0)

        self.statictext_swap_long_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_swap_long.Add(self.statictext_swap_long_value, 1, 0, 0)

        statictext_swap_long_per_lot = wx.StaticText(self.panel_main, wx.ID_ANY, "/ Lot")
        sizer_swap_long.Add(statictext_swap_long_per_lot, 1, 0, 0)

        self.statictext_swap_long_per_lot_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_swap_long.Add(self.statictext_swap_long_per_lot_value, 1, 0, 0)

        sizer_swap_short = wx.BoxSizer(wx.HORIZONTAL)
        sizer_main.Add(sizer_swap_short, 0, wx.EXPAND, 0)

        statictext_swap_short = wx.StaticText(self.panel_main, wx.ID_ANY, "Short:", style=wx.ALIGN_CENTER_HORIZONTAL)
        sizer_swap_short.Add(statictext_swap_short, 1, 0, 0)

        self.statictext_swap_short_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_swap_short.Add(self.statictext_swap_short_value, 1, 0, 0)

        statictext_swap_short_per_lot = wx.StaticText(self.panel_main, wx.ID_ANY, "/ Lot")
        sizer_swap_short.Add(statictext_swap_short_per_lot, 1, 0, 0)

        self.statictext_swap_short_per_lot_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_swap_short.Add(self.statictext_swap_short_per_lot_value, 1, 0, 0)

        sizer_margin = wx.BoxSizer(wx.HORIZONTAL)
        sizer_main.Add(sizer_margin, 0, wx.EXPAND | wx.TOP, 5)

        statictext_margin = wx.StaticText(self.panel_main, wx.ID_ANY, "Margin:")
        sizer_margin.Add(statictext_margin, 1, 0, 0)

        self.statictext_margin_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_margin.Add(self.statictext_margin_value, 1, 0, 0)

        statictext_margin_per_lot = wx.StaticText(self.panel_main, wx.ID_ANY, "/ Lot")
        sizer_margin.Add(statictext_margin_per_lot, 1, 0, 0)

        self.statictext_margin_per_lot_value = wx.StaticText(self.panel_main, wx.ID_ANY, "0")
        sizer_margin.Add(self.statictext_margin_per_lot_value, 1, 0, 0)
